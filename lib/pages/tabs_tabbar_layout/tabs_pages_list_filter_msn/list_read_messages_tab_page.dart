...
class ListReadMessagesTabPage extends StatefulWidget {
  const ListReadMessagesTabPage({super.key, this.idTabMark});

  final int? idTabMark;

  @override
  State<ListReadMessagesTabPage> createState() => _ListReadMessagesTabPageState();
}

class _ListReadMessagesTabPageState extends State<ListReadMessagesTabPage> {
  List notesList = [];
  ...
  // THE API CALL - PRINCIPAL METHOD #################################################################################################### START
  ...
  // THE API CALL - PRINCIPAL METHOD #################################################################################################### END
                        ...
                        if ((index < notesList.length)) {
                          return Padding(
                              ...
                              child: Card(
                                ...
                                color: notesList[index]['isViewed'] == true ? Colors.brown : Colors.black12,
                                child: ListTile(
                                  title: Text(
